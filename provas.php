	...
	<div id="maratona" class="col-sm-6">
		...
		<table id="prova" class="table table-striped table-bordered" cellspacing="0" width="100%">
		        ...
		        <tbody>
		            <tr>
		                ...
		                <td>Novembro, 25</td>
		                <td>0.00 km</td>		                
		                <td><button id="inscrever" type="button" class="btn btn-default btn-xs">clique aqui</button></td>		                
		            </tr>
		             ...
		             <tr>
		                ...
		                <td>Novembro, 26</td>
		                <td>10.00 km</td>		                
		                <td><button type="button" class="btn btn-default btn-xs">clique aqui</button></td>		                
		            </tr>
		...
		<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
		        ...
		        <tbody>
		            <tr>
		                ...
		                <td>Novembro, 25</td>
		                <td>0.00 km</td>		                
		                <td><button type="button" id="inscrito" class="btn btn-success btn-xs disabled">Inscrito!</button></td>	                
		            </tr>
		...
		<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
		        ...
		        <tr>
		                ...
		                <td>Novembro, 25</td>
		                <td>45.00 km</td>		                
		                <td><button type="button" class="btn btn-success btn-xs disabled">Inscrito!</button></td>		                
		            </tr>
		            <tr>
